import { ChairListParallel, ChairListProgram, ChairListPublicity, ChairListRegistration, ChairListWorkshop, ChairListLocalParallel, ChairListWorkshopCo, ChairListPublicityCo, ChairListOutreachCo, ChairListLogistics } from "~/lib/data";
...
export default defineEventHandler(async (event: any) => {
    ...
    else if (query.kind === 'Logistics Chair') {
        const data = {
            'status': 'Success',
