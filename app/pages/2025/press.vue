            ...
            <div class="bg-gray-50 p-6 rounded-lg">
              <div class="w-full max-w-4xl mx-auto">
                ...
                <div class="mt-4 text-center">
                  ...
                  <a 
                    href="/vedio.mp4" 
                    download="Harvard-EdUHK-Stanford-Symposium.mp4"
                    class="inline-flex items-center mt-2 px-4 py-2 bg-green-800 text-white rounded-md hover:bg-green-900 transition-colors duration-200"
                  >
