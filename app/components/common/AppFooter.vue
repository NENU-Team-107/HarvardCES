      ...
      <div class="max-w-screen-md row-span-1">
        <div class="flex flex-col text-justify mx-5">
          <div class="flex flex-col justify-center items-center py-3">
            <div v-for="(item, index) in contact" :key="index" class="flex flex-row w-full py-2 ">
              ...
              <div class="justify-self-start col-span-2 flex-1 text-center">
                ...
                <span v-if="item.before === 'Host.Location'" class="hover:text-blue-300">
                  <a
href="https://www.google.com/maps/place/The+Education+University+of+Hong+Kong+(EdUHK)/@22.4670285,114.1936333,17z/data=!3m1!4b1!4m6!3m5!1s0x340409071d2e8877:0x9062d0835c0a2b87!8m2!3d22.4670285!4d114.1936333!16zL20vMDNtdl9s?hl=en&entry=ttu&g_ep=EgoyMDI0MTExOS4yIKXMDSoASAFQAw%3D%3D"
                    target="_blank">
...
class="flex justify-center items-center" @mouseover="isHover[1] = true"
              ...
              <UButton
padded color="error" size="lg" square variant="soft"
                :class="isHover[1] ? 'mr-2 bg-white/60' : 'mr-2 bg-white'"
      ...
      <div class="grid  grid-rows-1 grid-cols-1 row-span-1">
        <div class="flex flex-col justify-center items-center">
          <div class="grid grid-rows-1 md:grid-cols-2 grid-cols-1 ">
            <div v-for="(item, index) in media" :key="index" class="ml-5">
              <div class="grid grid-rows-3 grid-cols-1 text-justify">
                <div class="row-span-2">
                  ...
                  <div class="flex justify-center items-center">
                    <NuxtImg v-if="item.label !== 'Email'" :src="item.image" class="w-24 h-24" />
                  </div>
                </div>
              </div>
            </div>
